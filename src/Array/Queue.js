...
// Can make 3 other function

function rear(){
// which return the rear element of the queue
// by arr[currentSize -1] // rear element
}
function front() {
  // which return the front element of the queue 
  // by arr[0] // front element

}
function isEmpty(){
  // which returns a boolean, check if the
  // currentSize <= 0 return true else false
